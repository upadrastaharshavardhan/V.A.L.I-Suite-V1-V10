"""
VALI Web Decoy v10 — Progressive + Canaries + Optional LLM feel
"""
...
SECRET = os.getenv("WEB_DECOY_SECRET", "change-me-to-a-very-long-random-string-v10")
...
async def api_health(request: Request):
    ...
    return {"status": "ok", "version": "10.0.0-internal", "env": "production"}
