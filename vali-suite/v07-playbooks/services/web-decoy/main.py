"""
VALI Web Decoy v7 — Progressive + Canaries + Optional LLM feel
"""
...
SECRET = os.getenv("WEB_DECOY_SECRET", "change-me-to-a-very-long-random-string-v7")
...
LOGGER_API_KEY = os.getenv("LOGGER_API_KEY", "vali-logger-secret-key-change-me-v7")
...
async def api_health(request: Request):
    ...
    return {"status": "ok", "version": "7.0.0-internal", "env": "production"}
