"""
VALI Web Decoy v8 — Progressive + Canaries + Optional LLM feel
"""
...
SECRET = os.getenv("WEB_DECOY_SECRET", "change-me-to-a-very-long-random-string-v8")
...
async def api_health(request: Request):
    ...
    return {"status": "ok", "version": "8.0.0-internal", "env": "production"}
