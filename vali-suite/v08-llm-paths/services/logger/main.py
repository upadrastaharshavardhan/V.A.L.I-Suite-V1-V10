"""
VALI Logger + Intelligence Engine v8
...
app = FastAPI(title="VALI Logger v8", version="8.0.0")
...
API_KEY = os.getenv("LOGGER_API_KEY", "vali-logger-secret-key-change-me-v8")
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "vali-logger", "version": "8.0.0"}
