"""
VALI Logger + Intelligence Engine v9
...
app = FastAPI(title="VALI Logger v9", version="9.0.0")
...
API_KEY = os.getenv("LOGGER_API_KEY", "vali-logger-secret-key-change-me-v9")
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "vali-logger", "version": "9.0.0"}
